...
const { getTransactionsByTransactionTypeOption } = transactionStore
...
interface TransctionListProps {
  optionSelected: TransactionTypesOptions
}

const props = defineProps<TransctionListProps>()

const transactionsByTransactionTypeOption = computed(() => getTransactionsByTransactionTypeOption(props.optionSelected))
</script>
...
<template>
  <base-table>
    ...
    <template #body>
      <base-table-body-row v-for="transaction in transactionsByTransactionTypeOption">
